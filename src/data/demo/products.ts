...
export const products: Product[] = [
  {
    ...
    price: 99.9,
    promoPrice: 79.9,
    images: ['/img/camisa5-modelo2.jpeg'],
    category: 'camisetas',
    variants: [sizes],
    available: true,
    featured: true,
  ...
  },
  {
    ...
    price: 99.9,
    images: ['/img/camisa7-modelo1.jpeg'],
    category: 'camisetas',
    variants: [sizes],
    available: true,
    featured: true,
  },
  {
    ...
    price: 99.9,
    images: ['/img/camisa2-modelo2.jpeg', '/img/camisa4-modelo1.jpeg'],
    category: 'camisetas',
    variants: [sizes],
    available: true,
    featured: true,
  ...
  },
  {
    ...
    price: 99.9,
    images: ['/img/camisa1-modelo1.jpeg'],
    category: 'camisetas',
    variants: [sizes],
    available: true,
  },
  {
    ...
    price: 99.9,
    images: ['/img/camisa3-modelo1.jpeg'],
    category: 'camisetas',
    variants: [sizes],
    available: true,
  },
  {
    ...
    price: 99.9,
    images: ['/img/camisa6-modelo2.jpeg'],
    category: 'camisetas',
    variants: [sizes],
    available: true,
    featured: true,
